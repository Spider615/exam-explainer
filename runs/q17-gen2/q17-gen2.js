window.Scenes["q17-gen2"] = function (fig) {
  var svg = fig.querySelector('svg');
  var riselane = fig.querySelector('#q17-gen2-riselane');
  var pathA = fig.querySelector('#q17-gen2-pathA');
  var pathB = fig.querySelector('#q17-gen2-pathB');
  var obj = fig.querySelector('#q17-gen2-obj');
  var ballA = fig.querySelector('#q17-gen2-ballA');
  var ballB = fig.querySelector('#q17-gen2-ballB');
  var labelA = fig.querySelector('#q17-gen2-labelA');
  var labelB = fig.querySelector('#q17-gen2-labelB');
  var arrowA = fig.querySelector('#q17-gen2-arrowA');
  var arrowB = fig.querySelector('#q17-gen2-arrowB');
  var landA = fig.querySelector('#q17-gen2-landA');
  var landB = fig.querySelector('#q17-gen2-landB');
  var dspan = fig.querySelector('#q17-gen2-dspan');
  var dlabel = fig.querySelector('#q17-gen2-dlabel');
  var tauDisplay = fig.querySelector('#q17-gen2-tau-display');
  var uDisplay = fig.querySelector('#q17-gen2-u-display');
  var phaseDisplay = fig.querySelector('#q17-gen2-phase-display');
  var yDisplay = fig.querySelector('#q17-gen2-y-display');
