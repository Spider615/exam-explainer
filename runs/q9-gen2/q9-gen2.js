window.Scenes["q9-gen2"] = function (fig) {
  ...
  // ---- 图内引用 ----
  var elA1 = svg.querySelector('#q9-gen2-a1-glow');
  var elA2 = svg.querySelector('#q9-gen2-a2-glow');
  var elA3 = svg.querySelector('#q9-gen2-a3-glow');
  var elCap = svg.querySelector('#q9-gen2-cap-charge');
  var elCoil = svg.querySelector('#q9-gen2-coil-glow');
  var elCurveI1 = svg.querySelector('#q9-gen2-curve-I1');
  var elCurveI2 = svg.querySelector('#q9-gen2-curve-I2');
  var elCurveI3 = svg.querySelector('#q9-gen2-curve-I3');
  var elCurI1 = svg.querySelector('#q9-gen2-cursor-I1');
  var elCurI2 = svg.querySelector('#q9-gen2-cursor-I2');
  var elCurI3 = svg.querySelector('#q9-gen2-cursor-I3');
  var elTxtI1 = svg.querySelector('#q9-gen2-txt-I1');
  var elTxtI2 = svg.querySelector('#q9-gen2-txt-I2');
  var elTxtI3 = svg.querySelector('#q9-gen2-txt-I3');
  var elTxtVc = svg.querySelector('#q9-gen2-txt-Vc');
  var elTxtVL = svg.querySelector('#q9-gen2-txt-VL');
  var elTxtT = svg.querySelector('#q9-gen2-txt-t');
  var elPhase = svg.querySelector('#q9-gen2-phase');
