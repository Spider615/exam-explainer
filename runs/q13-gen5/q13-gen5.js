window.Scenes["q13-gen5"] = function (fig) {
  var svg = fig.querySelector('svg');
  var abRod = fig.querySelector('#q13-gen5-abRod');
  var cdRod = fig.querySelector('#q13-gen5-cdRod');
  var Farrow = fig.querySelector('#q13-gen5-Farrow');
  var Fremoved = fig.querySelector('#q13-gen5-Fremoved');
  var flash = fig.querySelector('#q13-gen5-flash');
  var abPost = fig.querySelector('#q13-gen5-abPost');
  var cdPost = fig.querySelector('#q13-gen5-cdPost');
  var v1Marker = fig.querySelector('#q13-gen5-v1Marker');
  var v2Marker = fig.querySelector('#q13-gen5-v2Marker');
  var infoPhase = fig.querySelector('#q13-gen5-info-phase');
  var infoV1 = fig.querySelector('#q13-gen5-info-v1');
  var infoA1 = fig.querySelector('#q13-gen5-info-a1');
  var infoV2 = fig.querySelector('#q13-gen5-info-v2');
  var infoA2 = fig.querySelector('#q13-gen5-info-a2');
  var infoT = fig.querySelector('#q13-gen5-info-t');
  var infoQR = fig.querySelector('#q13-gen5-info-QR');
  var QRbar = fig.querySelector('#q13-gen5-QRbar');
  var infoV1post = fig.querySelector('#q13-gen5-info-v1post');
  var infoV2post = fig.querySelector('#q13-gen5-info-v2post');
